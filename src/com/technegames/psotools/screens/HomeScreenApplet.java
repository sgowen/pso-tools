 ...
 * @author arikardo77
 */
public final class HomeScreenApplet extends Applet
{
    ...
    {
        return TITLE + " - Copyright © 2012 Stephen Gowen";
    }

    public HomeScreenApplet()
    {
    ...
    private final class TabChangeListener implements ChangeListener
    {
        ...
        public void stateChanged(ChangeEvent e)
        {
            ...
            homeScreenPanels.get(currentTab).refreshUI(HomeScreenApplet.this);
        }
    }
